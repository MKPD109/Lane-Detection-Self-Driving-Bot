...
def process_img(original_image):
    ...
    try:
        ...
        m1,m2,l1, l2 = draw_lanes(original_image, lines)
...
def main():
    ...
    while True:
        ...
        processed_frame, original_frame, m1, m2 = process_img(frame)  #process_img now also returns m1, m2
        ...
        if cv2.waitKey(1) == 27:
            Break()  # Ensure vehicle stops or slows down before exiting
            break
...
# Placeholder for decision-making logic integration
# This should be based on the lane detection results (e.g., using m1, m2 values from line detection)
# Example (pseudocode):
# if lane_detection_result indicates turn right:
#     right()
# elif lane_detection_result indicates turn left:
#     left()
# else:
#     straight()
